%% contour of psi' for a tilted psi (see example in supplementary material)
% This script calculates the contour matrix of psi' when the user-defined
% potential, psi, is tilted. The contour matrix is stored in the 
% "contour" foldere
...
% save("contour/tilted_contour_matrix.mat", "tilted_contour_matrix");