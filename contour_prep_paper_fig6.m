%% contour of psi' for Figure 6 in our paper
...
fill(vx2, vy2, [233,185,136]/255); hold on;
plot(pgon1); hold on;
plot(pgon3); hold on;
plot(pgon4); hold on;
plot([proxy3(:,1); proxy3(1,1)], [proxy3(:,2); proxy3(1,2)], "r", 'LineWidth',1); hold on;
plot([proxy4(:,1); proxy4(1,1)], [proxy4(:,2); proxy4(1,2)], "r", 'LineWidth',1); hold on;
caxis([0 4]);
...
% save("contour/fig6_contour_matrix.mat", "fig6_contour_matrix");